...
export async function generateAnswer(
  ...
  INSTRUÇÕES:
    - use apenas informações contidas no contexto informado.
    - se a resposta não for encontrada no texto, apenas responda que não há informações o suficiente para responder.
    - Seja objetivo;
    - Mantenha um tom educativo e profissional;
    - Cite trechos relevantes do contexto se for relevante;
